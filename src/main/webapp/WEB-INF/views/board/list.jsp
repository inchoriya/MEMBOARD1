...
<script>
	...
	$(function(){
		...
		<c:forEach var="boardList" items="${boardList}" varStatus="i">
			obj = {
				"bNum" : '${boardList.BNum}',
				"bTitle" : '${boardList.BTitle}',
				"bWriter" : '${boardList.BWriter}',
				"bDate" : '${boardList.BDate}',
				"bHit" : '${boardList.BHit}'			
			}
	...
	function pagingList(page, list) {
		...
		for (var i = startRow; i <= endRow; i++) {
			...
			txt += "<tr>";
			txt += "<td>" + list[i].bNum + "</td>";
			txt += "<td><a href='bView?bNum="+list[i].bNum+"'>" + list[i].bTitle + "</a></td>";
			txt += "<td>" + list[i].bWriter + "</td>";
			txt += "<td>" + list[i].bDate + "</td>";
			txt += "<td>" + list[i].bHit + "</td>";
			txt += "</tr>";
		}
